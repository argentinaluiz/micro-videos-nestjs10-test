...
describe('Video Unit Tests', () => {
  ...
  describe('create command', () => {
    test('should create a video and no published video', () => {
      ...
      const markAsPublishedIfAllAudioVideoMediaAreCompleted = jest.spyOn(
  ...
  test('markAsPublishedIfAllAudioVideoMediaAreCompleted method', () => {
