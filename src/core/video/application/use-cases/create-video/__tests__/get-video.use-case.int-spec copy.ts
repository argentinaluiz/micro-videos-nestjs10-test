...
//             Array.from(e.categories_id.values()).map((c) => c.id),
//           ),
//           categories: expect.arrayContaining(
//             Array.from(e.categories_id.values()).map((c) => ({
//               id: c.id,
//               name: categories.find((e) => e.category_id.id === c.id)?.name,
//               created_at: categories.find((e) => e.category_id.id === c.id)
//                 ?.created_at,
//             })),
//           ),
//           is_active: true,
